...
#define BULK_DATA_FS_MAX_PACKET_SIZE                     64
#define BULK_DATA_HS_MAX_PACKET_SIZE                     512
#define BULK_CMD_PACKET_SIZE                             8     // Control Endpoint Packet size

#define USB_BULK_CONFIG_DESC_SIZ                         32

#define BULK_DATA_HS_IN_PACKET_SIZE                      BULK_DATA_HS_MAX_PACKET_SIZE
#define BULK_DATA_HS_OUT_PACKET_SIZE                     BULK_DATA_HS_MAX_PACKET_SIZE
